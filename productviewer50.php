...
<body>
    ...
    <script>
        ...
        function loadModel(textureURL) {
            ...
            loader.load('assets/3d/lemarikecil.glb', function (gltf) {
    ...
    <button id="kayuA" class="custom-btn" onclick="selectItem('kayuA')" style="background-image: url('assets/texture/kayu.jpg');"></button>
    <button id="kayuB" class="custom-btn" onclick="selectItem('kayuB')" style="background-image: url('assets/texture/kayuputih.jpg');"></button>
    <button id="kayuC" class="custom-btn" onclick="selectItem('kayuC')" style="background-image: url('assets/texture/kayu2.jpg');"></button>
    <button id="kayuD" class="custom-btn" onclick="selectItem('kayuD')" style="background-image: url('assets/texture/kayu3.jpg');"></button>
    <button class="custom-btn" id="kembaliBtn">Kembali</button>
    </div>
    <script>
    document.getElementById('kembaliBtn').addEventListener('click', function() {
        window.location.href = 'http://localhost/webasubagja/detail-produk.php?id=50';
    });
    </script>
</body>
