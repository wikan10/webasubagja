...
<div class="banner mb-3">
    <div class="container-fluid img">
        <div class="container-fluid box">
            <h3>BLOG</h3>
            <p>Home > <a href="#" class="text-warning">Blog</a></p>
        </div>
    </div>
</div>
<div class="container bg-white rounded pt-4">
    <!-- Atas -->
    <div class="row text-center mb-5" data-aos="fade-up" data-aos-duration="600">
        <?php
    ...
    <!-- Tengah -->
    <div class="row text-left mb-5" data-aos="fade-up" data-aos-duration="800">
        <?php
    ...
    <div class="Bawah">
        ...
        <div class="row mb-3">
            ...
            ?>
            <div class="col-md-4 col-sm-12 mb-4" data-aos="fade-up" data-aos-duration="800">
                <div class="imgup mb-2"><img src="admin/assets/images/foto_pos/<?php echo $data['gambar'];?>"
