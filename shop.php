...
<div class="banner mb-5">
    <div class="container-fluid img">
        <div class="container-fluid box">
            <h3>SHOP</h3>
            <p>Home > <a href="#" class="text-warning">Shop</a></p>
        </div>
    </div>
</div>
<div class="container" data-aos="fade-up" data-aos-duration="600" data-aos-delay="400">
    <?php 
    ...
    <div class="row data-aos="fade-up" data-aos-duration="800" data-aos-delay="600"">
        ...
        <div class="col-md-12 col-lg-8 col-xl-9">
            ...
            <div class="row" data-aos="fade-up" data-aos-duration="700" data-aos-delay="600">
                <?php
                    ...
                    <div class="item card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="detail-produk.php?id=<?php echo $produk['id_produk']; ?>"
                             class="btn btn-warning btn-sm btn-block">Lihat Produk</a>
                        </div>
                    </div>
                </div>
                <?php } ?>
