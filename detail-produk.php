    ...
    <div class="row">
        ...
        <div class="col-md-7 col-sm-12 pt-3 pl-5">
            ...
            <form method="post">
                <div class="row">
                    <div class="col-3">
                        ...
                        <div class="input-group spinner">
                            <button type="button" class="btn btn-warning btn-number pl-2 pr-2"
                ...
                <div class="row mt-3">
                    <div class="col-md-5">
                        <button class="btn btn-warning btn-block" name="beli">
                            <i class="fa fa-cart-plus" aria-hidden="true"></i> Masukkan Keranjang
                        </button>
                    </div>
                    <div class="col-md-5">
                        <button class="btn btn-warning btn-block ml-3" name="beli2">
                ...
                <div class="row mt-3">
                    <div class="col-md-5">
                        <button class="btn btn-warning btn-block" name="lihat">
                        <i class="fa fa-eye" aria-hidden="true"></i> Lihat 3D
                        </button>
                    </div>
        ...
        <?php
                ...
                elseif (isset($_POST['lihat'])) {
                    $produk = $id; 
                    echo "<script>location='productviewer{$produk}.php';</script>";
                }
            ?>
    </div>
    <br>
